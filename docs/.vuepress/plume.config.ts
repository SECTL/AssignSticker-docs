...
export default defineThemeConfig({
  ...
  social: [
    { icon: 'github', link: 'https://github.com/SECTL/Homeworklsland-docs' },
    {
      icon: {
      ...
      link: 'https://forum.smart-teach.cn/t/Homeworklsland'
    },
  ...
  copyright: { 
    license: {
      ...
      url: 'https://github.com/SECTL/Homeworklsland-docs/blob/main/LICENSE'
    },
    author: {
      name: 'SECTL',
      url: 'https://sectl.top'
