...
export default defineThemeConfig({
  ...
  social: [
    { icon: 'github', link: 'https://github.com/SECTL/AssignSticker-docs' },
    {
      icon: {
      ...
      link: 'https://forum.smart-teach.cn/t/AssignSticker'
    },
  ...
  copyright: { 
    license: {
      ...
      url: 'https://github.com/SECTL/AssignSticker-docs/blob/main/LICENSE'
    },
    author: {
      name: 'SECTL',
      url: 'https://sectl.top'
