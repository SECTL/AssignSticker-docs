<template><div><TeamCard lang="en" /><CardGrid class="container">
    <LinkCard title="Developer" href="https://github.com/chenghaolee-2012">
        <div class="card-content">
            <img src="/avatar/chenghaolee.png" alt="chenghaolee" width="80" />
            <div class="text-content">
                <p class="name">chenghaolee</p>
...
<VPComment class="comment" /></div></template>
